...
| 2. | 00:00 | Leaks, sage | 10 mins | chopping board, knife | Finely dice all the sage, add to saucepan with stock.  Top / tail leaks, remove outer layer, cut into coins, add to stock also to soften. | |
| 3. | 00:10 | Garlic, pecorno remano, lemon | 5 mins | chopping board, knife | Mince the garlic as thinly as you can, set aside on chopping board.  Grate the Pecorino romano on the finest side of grater, set aside on chopping board. Grate lemon zest, set aside on chopping board. | |
